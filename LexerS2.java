...
public class LexerS2 {
  ...
  private void scanToken() {
    ...
    switch (c) {
      case '(':
        addToken(TokenTypeS2.LEFT_PAREN);
        break;
      case ')':
        addToken(TokenTypeS2.RIGHT_PAREN);
        break;
      case '{':
        addToken(TokenTypeS2.LEFT_BRACE);
        break;
      case '}':
        addToken(TokenTypeS2.RIGHT_BRACE);
        break;
      case '[':
        addToken(TokenTypeS2.LEFT_BRACKET);
        break;
      case ']':
        addToken(TokenTypeS2.RIGHT_BRACKET);
        break;
      case ',':
        addToken(TokenTypeS2.COMMA);
        break;
      case '.':
        addToken(TokenTypeS2.DOT);
        break;
      case ';':
        addToken(TokenTypeS2.SEMICOLON);
        break;
      case ':':
        addToken(TokenTypeS2.COLON);
        break;
      case '!':
      ...
      case '-':
        if (match('-')) {         
          addToken(TokenTypeS2.MINUS_MINUS);          
        }
        else if (match('=')) {
            addToken(TokenTypeS2.MINUSEQUAL);
        }
        else {
          addToken(TokenTypeS2.MINUS);
         }
        break;
      case '+':
        if (match('+')) {          
          addToken(TokenTypeS2.PLUS_PLUS);
          
        }
        else if (match('=')) {
            addToken(TokenTypeS2.PLUSEQUAL);
        }
        else {
          addToken(TokenTypeS2.PLUS);
         }
        break;
      case '&':
      ...
      // break;
      case '*':
        addToken(match('=') ? TokenTypeS2.MULTEQUAL : TokenTypeS2.STAR);
        break;
      case '/':
        if (match('/')) {
  ...
  private void identifier() {
    ...
    if (text == "package")
      addToken(TokenTypeS2.PACKAGE);
    if (text == "import")
      addToken(TokenTypeS2.IMPORT);
